          ...
          ?>
          <div><form action="/php2/" class="settings-form" method="GET">
            <label>Wyszukaj:</label><div><input type="text" name="phrase" value="<?php echo $phrase ?>"/></div>
            <div>            <div>Sortuj po:</div>
            ...
            <div class="tbl-header">
              ...
              <tbody>
                <?php foreach($params['notes'] ?? [] as $note) :?>
                  <tr>
                    ...
                    <td><a href="/php2/?action=show&id=<?php echo $note['id'] ?>">
                    <button>Szczegóły</button></a>
                    <a href="/php2/?action=delete&id=<?php echo $note['id'] ?>">
             ...
             <li>
                  <a href="/php2/?page=<?php echo $currentPage - 1 . $paginationUrl ?>"> <button><<</button></a>
                </li>
                <?php endif; ?>
              <?php for($i = 1; $i <= $pages; $i++): ?>
                <li>
                  <a href="/php2/?page=<?php echo $i .$paginationUrl ?>"> <button><?php echo $i; ?></button></a>
                </li>
                <?php endfor; ?>
